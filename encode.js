...
export function generateSignature(method, path, params, headers, secret) {
  ...
  const signature = Base64.encode(hmacSha256(signatureText, secret))
...
export const request = ({
  ...
  params = {},
  data = {},
  secret = '42dbb95549efa327c617250efd39845c',
  clientId = '277152'
}) => {
  const headers = {
  ...
  const signature = generateSignature(method, path, params, headers, secret);
